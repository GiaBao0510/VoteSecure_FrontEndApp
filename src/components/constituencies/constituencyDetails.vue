<script>
    import EntityForm from './constituencyForm.vue';
    ...
    export default{
        ...
        methods:{
            ...
            async Update(data){
                try{
                    const response = await api.put(`${import.meta.env.VITE_CONSTITUENCY_API}/${data.iD_DonViBauCu}`,{
                        tenDonViBauCu: data.tenDonViBauCu,
                        diaChi: data.diaChi,
                        iD_QH: data.iD_QH,
                    });
            ...
            //Xóa
            async Delete(iD_DonViBauCu){
                try{
                    console.log("Xóa: ",iD_DonViBauCu);
                    console.log("Api: ",`${import.meta.env.VITE_CONSTITUENCY_API}/${iD_DonViBauCu}`);
