<script>
    import EntityForm from './provinceForm.vue';
    ...
    export default{
        ...
        methods:{
            ...
            async Update(data){
                try{
                    const response = await api.put(`${import.meta.env.VITE_PROVINCE_API}/${data.stt}`,{
                        stt: data.stt,
            ...
            async Delete(stt){
                try{
                    console.log("Xóa: ",stt);
                    console.log("Api: ",`${import.meta.env.VITE_PROVINCE_API}/${stt}`);
                    ...
                    if (result.isConfirmed) {
                        ...
                        const response = await api.delete(`${import.meta.env.VITE_PROVINCE_API}/${stt}`);
                        if (response.status === 200) {
                            Swal.fire({
                                icon: 'success',
