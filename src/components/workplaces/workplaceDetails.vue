<script>
    import EntityForm from './workplaceForm.vue';
    ...
    export default{
        ...
        methods:{
            ...
            async Update(data){
                try{
                    const response = await api.put(`${import.meta.env.VITE_CONSTITUENCY_API}/${data.iD_canbo}`,{
            ...
            async Delete(iD_canbo){
                try{
                    ...
                    console.log("Api: ",`${import.meta.env.VITE_WORKPLACE_DELETE_BY_IdCadre_API}/${iD_canbo}`);
                    ...
                    if (result.isConfirmed) {
                        const response = await api.delete(`${import.meta.env.VITE_CONSTITUENCY_API}/${iD_canbo}`);
                        if (response.status === 200) {
                            Swal.fire({
                                icon: 'success',
