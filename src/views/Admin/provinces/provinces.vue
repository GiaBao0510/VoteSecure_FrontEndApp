            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="DataModalLabel">Thêm</h5>
...
import AddForm from '../../../components/provinces/AddProvince.vue';
import Loading from '../../Loading.vue';
import { Modal } from 'bootstrap';
import DetailedForm from '../../../components/provinces/provincesDetails.vue';
...
export default {
    ...
    methods: {
        ...
        async fetchDatas() {
            this.isLoading = true;
            try {
                const res = await api.get(import.meta.env.VITE_PROVINCE_API);
                if (res.status === 200) {
