...
import AddForm from '../../../components/districts/AddDistrict.vue';
import Loading from '../../Loading.vue';
import { Modal } from 'bootstrap';
import DetailedForm from '../../../components/districts/districtDetails.vue';
...
export default {
    ...
    methods: {
        ...
        async fetchDatas() {
            this.isLoading = true; 
            try {
                const res = await api.get(import.meta.env.VITE_GET_ALL_DISTRICT_API);
                if (res.status === 200) {
